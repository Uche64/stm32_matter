...
CPP_SRCS += \
../Middlewares/Third_Party/connectedhomeip/src/access/tests/TestAccessControl.cpp 

OBJS += \
./Middlewares/Third_Party/connectedhomeip/src/access/tests/TestAccessControl.o 

CPP_DEPS += \
./Middlewares/Third_Party/connectedhomeip/src/access/tests/TestAccessControl.d 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Third_Party/connectedhomeip/src/access/tests/%.o Middlewares/Third_Party/connectedhomeip/src/access/tests/%.su Middlewares/Third_Party/connectedhomeip/src/access/tests/%.cyclo: ../Middlewares/Third_Party/connectedhomeip/src/access/tests/%.cpp Middlewares/Third_Party/connectedhomeip/src/access/tests/subdir.mk
...
clean: clean-Middlewares-2f-Third_Party-2f-connectedhomeip-2f-src-2f-access-2f-tests

clean-Middlewares-2f-Third_Party-2f-connectedhomeip-2f-src-2f-access-2f-tests:
	-$(RM) ./Middlewares/Third_Party/connectedhomeip/src/access/tests/TestAccessControl.cyclo ./Middlewares/Third_Party/connectedhomeip/src/access/tests/TestAccessControl.d ./Middlewares/Third_Party/connectedhomeip/src/access/tests/TestAccessControl.o ./Middlewares/Third_Party/connectedhomeip/src/access/tests/TestAccessControl.su

.PHONY: clean-Middlewares-2f-Third_Party-2f-connectedhomeip-2f-src-2f-access-2f-tests
