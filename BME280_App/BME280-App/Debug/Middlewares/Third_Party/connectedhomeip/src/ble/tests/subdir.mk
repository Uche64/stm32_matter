...
CPP_SRCS += \
../Middlewares/Third_Party/connectedhomeip/src/ble/tests/TestBleErrorStr.cpp \
../Middlewares/Third_Party/connectedhomeip/src/ble/tests/TestBleUUID.cpp 

OBJS += \
./Middlewares/Third_Party/connectedhomeip/src/ble/tests/TestBleErrorStr.o \
./Middlewares/Third_Party/connectedhomeip/src/ble/tests/TestBleUUID.o 

CPP_DEPS += \
./Middlewares/Third_Party/connectedhomeip/src/ble/tests/TestBleErrorStr.d \
./Middlewares/Third_Party/connectedhomeip/src/ble/tests/TestBleUUID.d 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Third_Party/connectedhomeip/src/ble/tests/%.o Middlewares/Third_Party/connectedhomeip/src/ble/tests/%.su Middlewares/Third_Party/connectedhomeip/src/ble/tests/%.cyclo: ../Middlewares/Third_Party/connectedhomeip/src/ble/tests/%.cpp Middlewares/Third_Party/connectedhomeip/src/ble/tests/subdir.mk
...
clean: clean-Middlewares-2f-Third_Party-2f-connectedhomeip-2f-src-2f-ble-2f-tests

clean-Middlewares-2f-Third_Party-2f-connectedhomeip-2f-src-2f-ble-2f-tests:
	-$(RM) ./Middlewares/Third_Party/connectedhomeip/src/ble/tests/TestBleErrorStr.cyclo ./Middlewares/Third_Party/connectedhomeip/src/ble/tests/TestBleErrorStr.d ./Middlewares/Third_Party/connectedhomeip/src/ble/tests/TestBleErrorStr.o ./Middlewares/Third_Party/connectedhomeip/src/ble/tests/TestBleErrorStr.su ./Middlewares/Third_Party/connectedhomeip/src/ble/tests/TestBleUUID.cyclo ./Middlewares/Third_Party/connectedhomeip/src/ble/tests/TestBleUUID.d ./Middlewares/Third_Party/connectedhomeip/src/ble/tests/TestBleUUID.o ./Middlewares/Third_Party/connectedhomeip/src/ble/tests/TestBleUUID.su

.PHONY: clean-Middlewares-2f-Third_Party-2f-connectedhomeip-2f-src-2f-ble-2f-tests
