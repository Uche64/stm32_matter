...
CPP_SRCS += \
../Middlewares/Third_Party/connectedhomeip/src/tracing/tests/TestMetricEvents.cpp \
../Middlewares/Third_Party/connectedhomeip/src/tracing/tests/TestTracing.cpp 

OBJS += \
./Middlewares/Third_Party/connectedhomeip/src/tracing/tests/TestMetricEvents.o \
./Middlewares/Third_Party/connectedhomeip/src/tracing/tests/TestTracing.o 

CPP_DEPS += \
./Middlewares/Third_Party/connectedhomeip/src/tracing/tests/TestMetricEvents.d \
./Middlewares/Third_Party/connectedhomeip/src/tracing/tests/TestTracing.d 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Third_Party/connectedhomeip/src/tracing/tests/%.o Middlewares/Third_Party/connectedhomeip/src/tracing/tests/%.su Middlewares/Third_Party/connectedhomeip/src/tracing/tests/%.cyclo: ../Middlewares/Third_Party/connectedhomeip/src/tracing/tests/%.cpp Middlewares/Third_Party/connectedhomeip/src/tracing/tests/subdir.mk
...
clean: clean-Middlewares-2f-Third_Party-2f-connectedhomeip-2f-src-2f-tracing-2f-tests

clean-Middlewares-2f-Third_Party-2f-connectedhomeip-2f-src-2f-tracing-2f-tests:
	-$(RM) ./Middlewares/Third_Party/connectedhomeip/src/tracing/tests/TestMetricEvents.cyclo ./Middlewares/Third_Party/connectedhomeip/src/tracing/tests/TestMetricEvents.d ./Middlewares/Third_Party/connectedhomeip/src/tracing/tests/TestMetricEvents.o ./Middlewares/Third_Party/connectedhomeip/src/tracing/tests/TestMetricEvents.su ./Middlewares/Third_Party/connectedhomeip/src/tracing/tests/TestTracing.cyclo ./Middlewares/Third_Party/connectedhomeip/src/tracing/tests/TestTracing.d ./Middlewares/Third_Party/connectedhomeip/src/tracing/tests/TestTracing.o ./Middlewares/Third_Party/connectedhomeip/src/tracing/tests/TestTracing.su

.PHONY: clean-Middlewares-2f-Third_Party-2f-connectedhomeip-2f-src-2f-tracing-2f-tests
