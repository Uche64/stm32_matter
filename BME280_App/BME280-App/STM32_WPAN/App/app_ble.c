...
static const uint8_t M_bd_addr[BD_ADDR_SIZE_LOCAL] =
    {
        (uint8_t)((CFG_OTP_BASE_ADDRESS & 0x0000000000FF)),
        (uint8_t)((CFG_OTP_BASE_ADDRESS & 0x00000000FF00) >> 8),
        (uint8_t)((CFG_OTP_BASE_ADDRESS & 0x000000FF0000) >> 16),
        (uint8_t)((CFG_OTP_BASE_ADDRESS & 0x0000FF000000) >> 24),
        (uint8_t)((CFG_OTP_BASE_ADDRESS & 0x00FF00000000) >> 32),
        (uint8_t)((CFG_OTP_BASE_ADDRESS & 0xFF0000000000) >> 40)
    };
...
const osThreadAttr_t ConnIntUpdateReqProcess_attr = {
  ...
  .cb_mem       = CFG_CONN_INT_UPD_REQ_PROCESS_CB_MEM,
  .cb_size      = CFG_CONN_INT_UPD_REQ_PROCESS_CB_SIZE,
  .stack_mem    = CFG_CONN_INT_UPD_REQ_PROCESS_STACK_MEM,
  .priority     = CFG_CONN_INT_UPD_REQ_PROCESS_PRIORITY,
...
static void Ble_Tl_Init( void )
{
 ...
 // manuf_data[ sizeof(manuf_data)-6] = bd_addr[5];
   ...
   */
  aci_hal_set_tx_power_level(1, CFG_BLE_MIN_TX_POWER);
