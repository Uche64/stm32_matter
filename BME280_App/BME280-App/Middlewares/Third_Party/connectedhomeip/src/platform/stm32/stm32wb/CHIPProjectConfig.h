...
#define CHIP_DEVICE_CONFIG_DEVICE_FIRMWARE_REVISION_STRING "1.21"
#endif
 ...
 *
 * Enable ICD management
 */
#define CHIP_CONFIG_ENABLE_ICD_SERVER 0  //set to 1 for GenericSwitch-App
...
#endif /* (CHIP_CONFIG_ENABLE_ICD_SERVER == 1) */
