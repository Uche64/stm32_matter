...
\
  ...
  { ZAP_SIMPLE_DEFAULT(0x00FA), 0x00000007, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(TOKENIZE) }, /* ColorTemperatureMireds */  \
  ...
  { ZAP_MIN_MAX_DEFAULTS_INDEX(3), 0x00004010, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(TOKENIZE) | ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* StartUpColorTemperatureMireds */  \
...
\
  ...
  { ZAP_SIMPLE_DEFAULT(2000), 0x00000000, 2, ZAP_TYPE(TEMPERATURE), ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* MeasuredValue */  \
  { ZAP_SIMPLE_DEFAULT(-4000), 0x00000001, 2, ZAP_TYPE(TEMPERATURE), ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* MinMeasuredValue */  \
  { ZAP_SIMPLE_DEFAULT(8500), 0x00000002, 2, ZAP_TYPE(TEMPERATURE), ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* MaxMeasuredValue */  \
  { ZAP_SIMPLE_DEFAULT(50), 0x00000003, 2, ZAP_TYPE(INT16U), 0 }, /* Tolerance */  \
  { ZAP_SIMPLE_DEFAULT(0), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 }, /* FeatureMap */  \
  { ZAP_SIMPLE_DEFAULT(1), 0x0000FFFD, 2, ZAP_TYPE(INT16U), 0 }, /* ClusterRevision */  \
\
...
\
  ...
  { ZAP_SIMPLE_DEFAULT(5000), 0x00000000, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* MeasuredValue */  \
  ...
  { ZAP_SIMPLE_DEFAULT(10), 0x00000003, 2, ZAP_TYPE(INT16U), 0 }, /* Tolerance */  \
  { ZAP_SIMPLE_DEFAULT(0), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 }, /* FeatureMap */  \
  { ZAP_SIMPLE_DEFAULT(3), 0x0000FFFD, 2, ZAP_TYPE(INT16U), 0 }, /* ClusterRevision */  \
\
...
\
  ...
  { ZAP_EMPTY_DEFAULT(), 0x0000FFFD, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* ClusterRevision */  \
\
  /* Endpoint: 4, Cluster: Pressure Measurement (server) */ \
  { ZAP_SIMPLE_DEFAULT(1013), 0x00000000, 2, ZAP_TYPE(INT16S), ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* MeasuredValue */  \
  { ZAP_SIMPLE_DEFAULT(300), 0x00000001, 2, ZAP_TYPE(INT16S), ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* MinMeasuredValue */  \
  { ZAP_SIMPLE_DEFAULT(1100), 0x00000002, 2, ZAP_TYPE(INT16S), ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* MaxMeasuredValue */  \
  { ZAP_SIMPLE_DEFAULT(10), 0x00000003, 2, ZAP_TYPE(INT16U), 0 }, /* Tolerance */  \
  { ZAP_SIMPLE_DEFAULT(0), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 }, /* FeatureMap */  \
  { ZAP_SIMPLE_DEFAULT(3), 0x0000FFFD, 2, ZAP_TYPE(INT16U), 0 }, /* ClusterRevision */  \
}
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 19, 207 }, \
  { ZAP_CLUSTER_INDEX(19), 10, 104 }, \
  { ZAP_CLUSTER_INDEX(29), 3, 23 }, \
  { ZAP_CLUSTER_INDEX(32), 3, 23 }, \
  { ZAP_CLUSTER_INDEX(35), 3, 23 }, \
}
...
#define FIXED_DEVICE_TYPES {{0x00000012,1},{0x00000016,3},{0x00000103,1},{0x00000302,1},{0x00000307,1},{0x00000305,1}}
...
#define FIXED_PARENT_ENDPOINTS { kInvalidEndpointId, 0, 0, 0, 0 }
