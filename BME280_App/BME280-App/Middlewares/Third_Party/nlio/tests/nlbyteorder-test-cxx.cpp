...
{
    NL_TEST_ASSERT(inSuite, Unknown      == static_cast<ByteOrder>(nlByteOrderUnknown));
    NL_TEST_ASSERT(inSuite, LittleEndian == static_cast<ByteOrder>(nlByteOrderLittleEndian));
    NL_TEST_ASSERT(inSuite, BigEndian    == static_cast<ByteOrder>(nlByteOrderBigEndian));
}
...
static void CheckByteOrder(nlTestSuite *inSuite, void *inContext)
{
    ...
    NL_TEST_ASSERT(inSuite, GetCurrent() != Unknown);
}
...
static void CheckSwapByValue(nlTestSuite *inSuite, void *inContext)
{
    ...
    v16_out = Swap16LittleToHost(v16_in);
    v32_out = Swap32LittleToHost(v32_in);
    v64_out = Swap64LittleToHost(v64_in);
    ...
    v16_in = Swap16HostToLittle(v16_out);
    v32_in = Swap32HostToLittle(v32_out);
    v64_in = Swap64HostToLittle(v64_out);
    ...
    v16_out = Swap16BigToHost(v16_in);
    v32_out = Swap32BigToHost(v32_in);
    v64_out = Swap64BigToHost(v64_in);
    ...
    v16_in = Swap16HostToBig(v16_out);
    v32_in = Swap32HostToBig(v32_out);
    v64_in = Swap64HostToBig(v64_out);
