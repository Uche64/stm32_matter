...
typedef enum
{
  ...
  MSG_M4TOM0_OT_ALARM_MILLI_GET_NOW,
  MSG_M4TOM0_OT_ALARM_MILLI_STOP,
  
  MSG_M4TOM0_OT_THREAD_GET_VENDOR_NAME,
  MSG_M4TOM0_OT_THREAD_GET_VENDOR_MODEL,
  MSG_M4TOM0_OT_THREAD_GET_VENDOR_SW_VERSION,
  MSG_M4TOM0_OT_THREAD_IS_ROUTER_ID_ALLOCATED,
  MSG_M4TOM0_OT_NET_DATA_GET_LENGTH,
  MSG_M4TOM0_OT_NET_DATA_GET_MAX_LENGTH,
  MSG_M4TOM0_OT_NET_DATA_RESET_MAX_LENGTH,
  MSG_M4TOM0_OT_NET_DATA_GET_NEXT_LOWPAN_CONTEXT_INFO,
  MSG_M4TOM0_OT_CONVERT_DURATION_IN_SECONDS_TO_STRING,
  MSG_M4TOM0_OT_INSTANCE_GET_ID,
  MSG_M4TOM0_OT_DNS_CLIENT_RESOLVE_SERVICE_AND_HOST_ADDRESS,
  MSG_M4TOM0_OT_DATASET_CONVERT_TO_TLVS,
  MSG_M4TOM0_OT_DATASET_UPDATE_TLVS,
  MSG_M4TOM0_OT_MESSAGE_RESET_BUFFER_INFO,
  MSG_M4TOM0_OT_CHILD_SUPERVISION_GET_CHECK_FAILURE_COUNTER,
  MSG_M4TOM0_OT_CHILD_SUPERVISION_RESET_CHECK_FAILURE_COUNTER,
  MSG_M4TOM0_OT_IP6_PREFIX_FROM_STRING,
  MSG_M4TOM0_OT_MESH_DIAG_DISCOVER_TOPOLOGY,
  MSG_M4TOM0_OT_MESH_DIAG_GET_NEXT_IP6_ADDRESS,
  MSG_M4TOM0_OT_MESH_DIAG_GET_NEXT_CHILD_INFO,
