...
static FACTORYDATA_StatusTypeDef Get_TagLocation(FACTORYDATA_TagId tag, uint32_t *out_Location,
        uint32_t *out_length);
...
FACTORYDATA_StatusTypeDef FACTORYDATA_GetValue(FACTORYDATA_TagId tag, uint8_t *data, uint32_t size,
        uint32_t *out_datalength) {
...
static FACTORYDATA_StatusTypeDef Get_TagLocation(FACTORYDATA_TagId tag, uint32_t *out_Location,
    ...
    do {
        ...
        Header_tag.tag_id = Header_data[0] + ((Header_data[1]) << 8) + ((Header_data[2]) << 16)
                + ((Header_data[3]) << 24);
        Header_tag.data_length = Header_data[4] + ((Header_data[5]) << 8) + ((Header_data[6]) << 16)
                + ((Header_data[7]) << 24);
